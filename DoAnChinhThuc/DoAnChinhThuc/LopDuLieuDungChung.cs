...
{
    class LopDuLieuDungChung :DataTable
    {
        //Biến toàn cục
        ...
        public string ConnectionString()
        {
            ...
            builder["Server"] = "DESKTOP-HD4HHJ3\\SQLEXPRESS";
            builder["Database"] = "CSDL_DoAnQLBNNhaKhoa";
        ...
        public void Fill(SqlCommand selectCommand)
        {
            ...
            try
            {
                ...
                adapter.SelectCommand = command; this.Clear();
                adapter.Fill(this);
            }
            catch (Exception ex)
            {
